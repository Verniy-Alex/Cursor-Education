...
function generateBlocks() {
    for (let i = 0; i < 25; i++) {
        ...
        colorBlock.classList.add('blocks')
        colorBlock.style.backgroundColor = colors[getRandomColor()]
...
function generateBlocksInterval() {
    setInterval(function () {
        const intervalBlocks = document.querySelectorAll('.blocks')
        intervalBlocks.forEach(el => {
            el.style.backgroundColor = colors[getRandomColor()]
        })
    }, 1000)
}
